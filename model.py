...
class Customer(object):
  """A wrapper object that corresponds to rows in the melons table."""
  def __init__(self, id, givenname,surname,email,shipto_address1,shipto_city,shipto_state,shipto_postalcode):
      self.id = id
...
def get_customer_by_email(email):
    cursor = connect()
    query = """SELECT id, givenname, surname, email, shipto_address1, 
